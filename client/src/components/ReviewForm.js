...
class ReviewForm extends Component {
  ...
  sendMessage(event) {
    ...
    axios
      .post("/api/addReview", this.state)
      .then((res) => {
        //  console.log(res);
        toast.success("Thank You for Reviewing me, keep encouraging people !", {
          position: toast.POSITION.TOP_CENTER,
          autoClose: false,
        });
        this.setState({
                ...
                <div className="row">
                  <div className="col-xs-12 col-sm-12 col-md-4">
                    <div className="form-group row">
                      <label htmlFor="inputEmail" className="col col-12">
                        Your Name
                      </label>
                      <div className="col col-12">
                        <input
                          ...
                          id="inputName"
                          placeholder="Your name is visible"
                    ...
                    <div className="form-group row">
                      <label htmlFor="inputName" className="col col-12">
                        How do you Know me{" "}
                      </label>
                      <div className="col col-12">
                        ...
                        <select
                          id="rel"
                          className="form-control col col-12"
                          name="rel"
                          onChange={this.handleChangeRel}
                        >
                          <option value="I worked directly for You">
                            I worked directly for You
                          </option>
                          <option value="You and me worked together">
                            You and me worked together
                          </option>
                  ...
                  <div className="col-md-4 col-xs-12 col-sm-12">
                    <div className="form-group row">
                      <label
                        ...
                        className="col col-12 col-form-label"
                      >
                        Review
                      </label>
                      <div className="col col-12">
                        <textarea
                          type="text"
                          className=" col col-12 form-control"
                          id="inputMessage"
                          value={this.state.inputMessage}
                          placeholder="Tell everyone about me in 115 letters"
                        //   maxLength="115"
                          rows="5"
                          cols="50"
